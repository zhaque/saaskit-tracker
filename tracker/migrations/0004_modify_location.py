...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tracker.radius'
        db.add_column('tracker_tracker', 'radius', orm['tracker.tracker:radius'])
        
        # Adding field 'Tracker.location'
        db.add_column('tracker_tracker', 'location', orm['tracker.tracker:location'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Tracker.radius'
        db.delete_column('tracker_tracker', 'radius')
        
        # Deleting field 'Tracker.location'
        db.delete_column('tracker_tracker', 'location')
